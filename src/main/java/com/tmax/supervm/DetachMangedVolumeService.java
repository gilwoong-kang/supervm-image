...
public class DetachMangedVolumeService extends AbstractServiceObject {
    private final String DETACH_MV_METHOD = "ManagedVolume.detach_volume";
    ...
    public void service(BodyObject bodyObject) {
        ...
        request.addProperty("method",DETACH_MV_METHOD);
        try {
