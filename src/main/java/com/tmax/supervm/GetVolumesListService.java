...
public class GetVolumesListService extends AbstractServiceObject {
    private final String GET_VOLUMES_LIST_METHOD = "StorageDomain.getVolumes";
    @Override
    public void service(BodyObject bodyObject) {
        ...
        request.addProperty("method",GET_VOLUMES_LIST_METHOD);
        try {
