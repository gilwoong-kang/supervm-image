...
public class GetImagesListService extends AbstractServiceObject {
    private final String GET_IMAGES_LIST_METHOD = "StorageDomain.getImages";
    @Override
    public void service(BodyObject bodyObject) {
        ...
        request.addProperty("method",GET_IMAGES_LIST_METHOD);
        try {
